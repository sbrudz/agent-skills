...
| [revise-for-clarity](skills/revise-for-clarity/SKILL.md) | Revises existing prose to be shorter and clearer in four passes: structure, hierarchy, clarity, reader calibration — design docs and RFCs through to PR descriptions and email. Subtraction, never addition. Catches ideas named instead of stated, walkthroughs that bury the argument, prose that overpromises, and claims you cannot place as shipped or proposed. Invoke it explicitly, on text that already exists. |
