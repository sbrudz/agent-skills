...
| [writing-clear-tech-docs](skills/writing-clear-tech-docs/SKILL.md) | Makes a design doc, RFC, or ADR shorter and clearer in four passes: structure, hierarchy, clarity, reader calibration. Revises by subtraction, never addition. Catches what survives a good revision — ideas named instead of stated, walkthroughs that bury the argument or use an impossible example, prose that overpromises. |
