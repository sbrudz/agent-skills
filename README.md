...
| [writing-clear-tech-docs](skills/writing-clear-tech-docs/SKILL.md) | Four-pass layered writing process for creating and revising technical documents (design docs, RFCs, ADRs) intended for fellow engineers. Encodes principles from Minto, Williams, Zinsser, and others into concrete revision passes: structure (pyramid, SCQA), hierarchy (C4 zoom levels), clarity (given-new, concision, concrete anchoring), and reader calibration (curse of knowledge countermeasures). Core principle: revise by subtraction and restructuring, never by addition. |
